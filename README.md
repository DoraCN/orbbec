...
OrbbecSDK-v2-compatible Orbbec device.
...
- Depth cameras have a **model-dependent minimum working range**; objects closer
  than it produce no reliable depth (the SDK emits garbage values).
